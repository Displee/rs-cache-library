...
public class Constants {
	...
	/**
	 * The size of the header within an archive in bytes.
	 */
	public static final int ARCHIVE_HEADER_SIZE = 8;

	/**
	 * The size of the data within an archive in bytes.
	 */
	public static final int ARCHIVE_DATA_SIZE = 512;

	/**
	 * The total size of an archive in bytes.
	 */
	public static final int ARCHIVE_SIZE = ARCHIVE_HEADER_SIZE + ARCHIVE_DATA_SIZE;

	/**
	 * The size of a whirlpool byte array in bytes.
	 */
