...
public class Whirlpool {
	...
	static {
		...
		for (int r = 1; r <= 10; r++) {
			int i = 8 * (r - 1);
			aLongArray9[r] = (aLongArrayArray8[0][i] & ~0xffffffffffffffL ^ aLongArrayArray8[1][i + 1] & 0xff000000000000L ^ aLongArrayArray8[2][i + 2] & 0xff0000000000L ^ aLongArrayArray8[3][i + 3] & 0xff00000000L ^ aLongArrayArray8[4][i + 4] & 0xff000000L ^ aLongArrayArray8[5][i + 5] & 0xff0000L ^ aLongArrayArray8[6][i + 6] & 0xff00L ^ aLongArrayArray8[7][i + 7] & 0xffL);
		}
	}
	...
	public static byte[] generate(byte[] data, int off, int len) {
		byte[] source;
		if (off <= 0) {
			source = data;
		} else {
